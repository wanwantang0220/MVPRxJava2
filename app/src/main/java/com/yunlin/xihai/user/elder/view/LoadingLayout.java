...
public class LoadingLayout extends FrameLayout {
    ...
    public LoadingLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTextSize = a.getDimensionPixelSize(R.styleable.LoadingLayout_llTextSize, AppUtil.dip2px(context, 16));

        mButtonTextColor = a.getColor(R.styleable.LoadingLayout_llButtonTextColor, 0xff999999);
        mButtonTextSize = a.getDimensionPixelSize(R.styleable.LoadingLayout_llButtonTextSize, AppUtil.dip2px(context, 16));
        mButtonBackground = a.getDrawable(R.styleable.LoadingLayout_llButtonBackground);

        mEmptyResId = a.getResourceId(R.styleable.LoadingLayout_llEmptyResId, R.layout.empty_view);
        mLoadingResId = a.getResourceId(R.styleable.LoadingLayout_llLoadingResId, R.layout.load_view);
        mErrorResId = a.getResourceId(R.styleable.LoadingLayout_llErrorResId, R.layout.error_view);

        mShowLoading = a.getBoolean(R.styleable.LoadingLayout_llShowLoading, true);
    ...
    public LoadingLayout setTextSize(@ColorInt int dp) {
        mTextSize = AppUtil.dip2px(getContext(), dp);
        return this;
    }
    ...
    public LoadingLayout setButtonTextSize(@ColorInt int dp) {
        mButtonTextSize = AppUtil.dip2px(getContext(), dp);
        return this;
    }
